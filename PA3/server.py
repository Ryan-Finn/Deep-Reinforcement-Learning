...
# env = gym.wrappers.Monitor(env, './tmp/mountain-car-1')
...
axes[0].imshow(value_left.reshape((num_rbf[0], num_rbf[1])), cmap='hot')
axes[0].set_title('Action = left')
axes[0].set_ylabel('Position')
axes[0].set_xlabel('Velocity')
axes[1].imshow(value_nothing.reshape((num_rbf[0], num_rbf[1])), cmap='hot')
